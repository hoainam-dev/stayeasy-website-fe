...
export default function RegisterHost() {
  ...
  const handleRegister = () => {
    dispatch(updateInformation("Quyền", raw))
  }
  ...
  return (
    <div>
      ...
      <div className="fixed inset-0 flex items-center justify-center overflow-auto">
        <div className='className="px-10 py-4 overflow-auto max-h-[88%] max-h-[200px]:max-h-[30%] z-50"'>
          <div className="mb-4">
              <label className="block text-gray-800 font-medium mb-2">
                  Số tài khoản<span className="text-red-500"> (*)</span>
              </label>

              <input type="text" value={account} className="border rounded-2xl text-gray-700 px-[1.4rem] py-3 my-2 w-full"
              onChange={(e) => {
